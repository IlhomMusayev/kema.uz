...
function splitOnFirst(str, sep) {
  ...
  return index < 0 ? [str] : [str.slice(0, index), str.slice(Number(index) + Number(sep.length))];
}
...
var toColorValue = function (maybeFunction) { return typeof maybeFunction === 'function' ? maybeFunction({}) : maybeFunction; };
...
var dynamicStyles = {
  ...
  text: {
    value: function (ref) {
      var filterColor = ref.filterColor;
      var value = ref.value;

      return filterColor(['--tw-text-opacity', 'color'], value);
},
    plugin: 'text'
  },
  ...
  bg: {
    value: function (ref) {
      ...
      return filterColor(['--tw-bg-opacity', 'backgroundColor'], value);
},
    plugin: 'bg'
  },
  // https://tailwindcss.com/docs/gradient-color-stops
  ...
  ring: {
    value: function (ref) {
      ...
      return filterColor(['--tw-ring-opacity', '--tw-ring-color'], value);
},
    plugin: 'ring'
  },
...
var staticStyles = {
  ...
  'backdrop-filter': {
    output: {
      ...
      backdropFilter: ['var(--tw-backdrop-blur)', 'var(--tw-backdrop-brightness)', 'var(--tw-backdrop-contrast)', 'var(--tw-backdrop-grayscale)', 'var(--tw-backdrop-hue-rotate)', 'var(--tw-backdrop-invert)', 'var(--tw-backdrop-opacity)', 'var(--tw-backdrop-saturate)', 'var(--tw-backdrop-sepia)'].join(' ')
    }
  },
  // https://tailwindcss.com/docs/backdrop-blur
  // https://tailwindcss.com/docs/backdrop-brightness
...
var validImports = new Set(['default', 'styled', 'css', 'theme', 'screen', 'TwStyle', 'ThemeStyle', 'GlobalStyles']);
...
var configTwinValidators = {
  preset: [function (value) { return value === undefined || ['styled-components', 'emotion', 'goober'].includes(value); }, "The config “preset” can only be set to ‘emotion’ (default), ‘styled-components’ or ‘goober’"],
...
var getConfigTailwindProperties = function (state, config) {
  ...
  var configTailwind = configExists ? resolveTailwindConfig([].concat( getAllConfigs(require(configPath)) )) : resolveTailwindConfig([].concat( getAllConfigs(defaultTailwindConfig) ));
...
var maybeAddCssProperty = function (ref) {
  ...
  program.traverse({
    ImportDeclaration: function ImportDeclaration(path$$1) {
      ...
      } else if (path$$1.node.source.value === './macro') {
        // Read the test import with a comment of (// twinImport) afterwards
        var ref = path$$1.node.source;
        var trailingComments = ref.trailingComments;
...
var tailwindBaseStyles = function (ref) {
  var theme = ref.theme;

  return ("\n  blockquote,\n  dl,\n  dd,\n  h1,\n  h2,\n  h3,\n  h4,\n  h5,\n  h6,\n  hr,\n  figure,\n  p,\n  pre {\n    margin: 0;\n  }\n\n  button {\n    background-color: transparent;\n    background-image: none;\n  }\n\n  button:focus {\n    outline: 1px dotted;\n    outline: 5px auto -webkit-focus-ring-color;\n  }\n\n  fieldset {\n    margin: 0;\n    padding: 0;\n  }\n\n  ol,\n  ul {\n    list-style: none;\n    margin: 0;\n    padding: 0;\n  }\n\n  html {\n    font-family: " + (theme(templateObject) || "ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\"") + ";\n    line-height: 1.5;\n  }\n\n  body {\n    font-family: inherit;\n    line-height: inherit;\n  }\n\n  *,\n  ::before,\n  ::after {\n    box-sizing: border-box;\n    border-width: 0;\n    border-style: solid;\n    border-color: " + (theme(templateObject$1) || "currentColor") + ";\n  }\n\n  hr {\n    border-top-width: 1px;\n  }\n\n  img {\n    border-style: solid;\n  }\n\n  textarea {\n    resize: vertical;\n  }\n\n  input::placeholder,\n  textarea::placeholder {\n    color: " + (theme(templateObject$2) || "#a1a1aa") + ";\n  }\n\n  button,\n  [role=\"button\"] {\n    cursor: pointer;\n  }\n\n  table {\n    border-collapse: collapse;\n  }\n\n  h1,\n  h2,\n  h3,\n  h4,\n  h5,\n  h6 {\n    font-size: inherit;\n    font-weight: inherit;\n  }\n\n  a {\n    color: inherit;\n    text-decoration: inherit;\n  }\n\n  button,\n  input,\n  optgroup,\n  select,\n  textarea {\n    padding: 0;\n    line-height: inherit;\n    color: inherit;\n  }\n\n  pre,\n  code,\n  kbd,\n  samp {\n    font-family: " + (theme(templateObject$3) || "ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, \"Liberation Mono\", \"Courier New\", monospace") + ";\n  }\n\n  img,\n  svg,\n  video,\n  canvas,\n  audio,\n  iframe,\n  embed,\n  object {\n    display: block;\n    vertical-align: middle;\n  }\n\n  img,\n  video {\n    max-width: 100%;\n    height: auto;\n  }\n");
};

var globalPreflightStyles = function (ref) {
  var theme = ref.theme;

  return [modernNormalizeStyles, tailwindBaseStyles({
  theme: theme
})].join("\n");
};
...
var globalKeyframeStyles = function (ref) {
  ...
  if (!keyframes) { return; }
  return Object.entries(keyframes).map(function (ref) {
    var name = ref[0];
    var frames = ref[1];

    return ("\n      @keyframes " + name + " {" + (Object.entries(frames).map(function (ref) {
        var offset = ref[0];
        var styles = ref[1];

        return ("\n          " + offset + " { \n            " + (Object.entries(styles).map(function (ref) {
              var key = ref[0];
              var value = ref[1];
...
var handleColor = function (ref) {
  ...
  if (!value) { return; }
  return Object.assign({}, {'--tw-ring-opacity': '1'},
    withAlpha({
      color: value,
...
var globalBoxShadowStyles = function () { return "* {\n  --tw-shadow: 0 0 #0000; }\n"; };
...
var globalStyles = [globalPreflightStyles, globalKeyframeStyles, globalRingStyles, globalBoxShadowStyles];
...
var handleGlobalStylesFunction = function (ref) {
  ...
  throwIf(state.isStyledComponents && !parentPath, function () { return logGeneralError('GlobalStyles must be added as a JSX element, eg: <GlobalStyles />'); });
  ...
  var strippedPlugins = filterClassSelectors(state.userPluginData && state.userPluginData.base); // Provide each global style function with context and convert to a string

  var baseStyles = convertCssObjectToString(strippedPlugins);
  var styles = [globalStyles.map(function (globalFunction) { return globalFunction({
    theme: theme
  }); }).join('\n'), baseStyles].filter(Boolean).join('\n');
  ...
  if (state.isGoober) {
    var declaration$2 = getGlobalDeclarationTte({
      t: t,
      globalUid: globalUid,
      stylesUid: stylesUid,
      styles: styles
...
function spreadVariantGroups(classes, context, importantContext, start, end) {
  ...
  while (match = reg.exec(classes)) {
    ...
    if (variant) {
      context += variant; // Skip empty classes
...
var mergeImportant = function (style, hasImportant) {
  if (!hasImportant) { return style; } // Bail if the ruleset already has an important - for arbitrary values
...
var splitters = [splitVariants, splitPrefix, splitNegative, splitImportant];
...
var handleDynamic = (function (ref) {
  ...
  var results = styleSet.map(function (item) { return ({
    ...
    negative: negative
  }); }).find(function (item) { return item.value; });
...
var gradient = (function (properties) {
  ...
  var styleDefinitions = {
    ...
    via: {
      '--tw-gradient-stops': ("var(--tw-gradient-from), " + (getColorValue(value, 'via')) + ", var(--tw-gradient-to, " + (transparentTo(value)) + ")")
    },
    to: {
...
var handleCorePlugins = (function (ref) {
  ...
  var match = function (regex) { return get(pieces.className.match(regex), [0]) || null; };
...
var showSuggestions = function (ref) {
  var classProperty = ref.classProperty;
  var customValue = ref.customValue;

  var suggestions = getSuggestions$1(classProperty, customValue);
  throwIf(true, function () { return logBadGood(("The arbitrary class “" + classProperty + "” in “" + classProperty + "-[" + customValue + "]” wasn’t found"), suggestions.length > 0 && ("Try one of these:\n\n" + (suggestions.join(', ')))); });
};
...
var handleArbitraryCss = (function (ref) {
  ...
  var ref$1 = splitOnFirst(className // Replace the "stand-in spaces" with real ones
  .replace(new RegExp(SPACE_ID, 'g'), ' '), '[');
  var classProperty = ref$1[0];
  var customValue = ref$1[1];
  ...
  var config = searchDynamicConfigByProperty(classProperty) || {};
  (isEmpty(config) || Array.isArray(config)) && showSuggestions({
    classProperty: classProperty,
    customValue: customValue
  });
  throwIf(config.hasArbitrary === false, function () { return logBadGood(("There is no support for the arbitrary value “" + classProperty + "” in “" + classProperty + "-[" + customValue + "]”")); });
  var property = config.prop;

  var filterColor = function (properties, value) { return withAlpha({
    color: value,
  ...
  var value = typeof config.value === 'function' ? config.value({
    value: customValue,
    filterColor: filterColor,
    transparentTo: transparentTo
  }) : customValue;
  if (!property) { return value ? value : showSuggestions({
    classProperty: classProperty,
    customValue: customValue
  }); }
  if (Array.isArray(property)) { return property.reduce(function (result, p) {
    var obj;
...
var formatTasks$1 = [// Strip pipe dividers " | "
function (ref) {
...
var getStyleData = (function (classes, ref) {
  ...
  var styles = classes.reduce(function (results, classNameRaw) {
    ...
    !silentMismatches && doPrechecks([precheckGroup, preCheckPrefix, preCheckNoHyphenSuffix], {
      pieces: pieces,
      classNameRaw: classNameRaw,
      state: state
    ...
    var styleHandler = {
      ...
      css: function () { return handleCss({
        className: className
      }); },
      arbitraryCss: function () { return handleArbitraryCss({
        className: className,
        pieces: pieces
      }); },
...
var handleTwFunction = function (ref) {
  ...
  defaultImportReferences.forEach(function (path$$1) {
     ...
     */
    if (!path$$1.parentPath.isTaggedTemplateExpression()) {
      path$$1.scope.crawl();
    }
...
var getUserPluginRules = function (rules, screens, isBase) { return ruleSorter(rules).reduce(function (result, rule) {
  ...
  if (rule.type !== 'atrule') {
    var builtRules = getBuiltRules(rule, {
      isBase: isBase
    });
...
var twinMacro = function (ref) {
  ...
  program.traverse({
    ...
    JSXElement: function JSXElement(path$$1) {
      ...
      var jsxAttributes = allAttributes.filter(function (attribute) { return attribute.isJSXAttribute(); });
  ...
  if ((state.hasTwAttribute || state.hasCssAttribute) && configTwin.autoCssProp === true && state.isStyledComponents) {
    maybeAddCssProperty({
      program: program,
      t: t
    });
